...
def seed_db():
    ...
    with app.app_context():
        ...
        if Restaurant.query.count() == 0:
            ...
            r7 = Restaurant(name="Steak Grill", city="Санкт-Петербург", delivery_time=55,
                            image="images/steak_grill.png")
            ...
            # --- Блюда С КАТЕГОРИЯМИ (ничего не удалено, только добавлено category=) ---
            menu_items = [
                # ========== Pizza House (пицца) ==========
                ...
                MenuItem(name="Coca-cola", price=100,
                         description="Очищенная газированная вода, сахар, краситель карамель", weight="330 мл",
                ...
                MenuItem(name="Молочный коктейль: шоколадный", price=560,
                         description="Молоко, мороженое, шоколадный сироп", weight="500 г", restaurant_id=r2.id,
                         image="images/chocomilk.png", category="drink"),
                MenuItem(name="Молочный коктейль: ванильный", price=560,
                         description="Молоко, мороженое, ванильный сироп", weight="500 г", restaurant_id=r2.id,
                         image="images/milk.png", category="drink"),
                MenuItem(name="Молочный коктейль: клубничный", price=560,
                         description="Молоко, мороженое, клубничный сироп", weight="500 г", restaurant_id=r2.id,
                         image="images/strawmilk.png", category="drink"),
                ...
                MenuItem(name="Бургер BBQ", price=470,
                         description="Говяжья котлета с соусом BBQ и карамелизированным луком", weight="280 г",
                         restaurant_id=r3.id, image="images/restaurant3_dish6.png", category="burger"),
                MenuItem(name="Яблочный сок", price=280, description="Свежевыжатый яблочный сок", weight="300 мл",
                ...
                MenuItem(name="Мексиканский бургер", price=460,
                         description="Говяжья котлета с перцем чили и острым соусом", weight="280 г",
                         restaurant_id=r3.id, image="images/restaurant3_dish9.png", category="burger"),
                MenuItem(name="Coca-cola", price=100,
                         description="Очищенная газированная вода, сахар, краситель карамель", weight="330 мл",
                         restaurant_id=r3.id, image="images/cola.png", category="drink"),

                # Burger King ЗАВТРАКИ
                ...
                MenuItem(name="Буррито", price=400, description="Мясо, рис, овощи", weight="350 г", restaurant_id=r4.id,
                         image="images/burrito.png", category="burger"),
                ...
                MenuItem(name="Лазанья", price=600, description="Мясо, соус, сыр", weight="450 г", restaurant_id=r5.id,
                         image="images/lasagna.png", category="pizza"),
                ...
                MenuItem(name="Тирамису", price=300, description="Десерт с кофе и сыром маскарпоне", weight="150 г",
                         restaurant_id=r10.id, image="images/tiramisu.png", category="other"),
                MenuItem(name="Мороженое ванильное", price=150, description="Классическое ванильное мороженое",
                         weight="100 г", restaurant_id=r10.id, image="images/icecream.png", category="other"),
                # Добавь эти строки в секцию menu_items в commands.py:
